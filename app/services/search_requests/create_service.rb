module SearchRequests
  class CreateService
    ...
    def initialize(params:, search_request_repository: SearchRequestRepository.new, exchange_rate_repository: ExchangeRateRepository.new)
    ...
    attr_reader :params, :search_request_repository, :exchange_rate_repository
