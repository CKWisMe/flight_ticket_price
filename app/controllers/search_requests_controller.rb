class SearchRequestsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if result.success?
        format.html { redirect_to search_request_path(result.search_request), notice: I18n.t("search_requests.flash.created") }
        format.json do
        ...
        format.html do
          ...
          flash.now[:alert] = I18n.t("search_requests.flash.invalid")
